...
def run_multihead_self_attention(
    ...
    model.load_state_dict({"q_proj.weight": q_proj_weight, "k_proj.weight": k_proj_weight, "v_proj.weight": v_proj_weight, "output_proj.weight": o_proj_weight})
    return model(in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    model = MultiHeadSelfAttention(d_model = d_model, num_heads = num_heads, rope = rope)
    model.load_state_dict({"q_proj.weight": q_proj_weight, "k_proj.weight": k_proj_weight, "v_proj.weight": v_proj_weight, "output_proj.weight": o_proj_weight})
